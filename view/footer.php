  ...
  <footer class="footer">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="view/img/logo3.png" alt=""></a>
                        </div>
                ...
                <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__newslatter">
                            <p>Hãy là người đầu tiên biết về hàng mới đến, xem sách, bán hàng và khuyến mãi!</p>
                            <form action="#">
                ...
                <div class="col-lg-12 text-center">
                    <div class="footer__copyright__text">
                        ...
                        <p>
                            ...
                            Bản quyền © 2023 của HTD Sneaker . Đã đăng ký Bản quyền.
                        </p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
    ...
    <div class="search-model">
        <div class="h-100 d-flex align-items-center justify-content-center">
            ...
            <form action="index.php?act=sanpham" method="post" class="search-model-form">
                <input type="text" name="kyw" id="search-input" placeholder="Search here.....">
...
<!-- <script>
  const tudong_chatbox = new TuDongChat('Z0tAQwKzuaci5bZL7r0tm')
