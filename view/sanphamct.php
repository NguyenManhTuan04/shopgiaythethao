              ...
              <div class="row d-flex justify-content-center">
                  <div class="col-lg-8">
                      <div class="product__details__text">
                          ...
                          <h3 style="color:red;"><?= $price_sp ?> VNĐ<span></span></h3>
                          <p><?= $mota_sp ?></p>
                                  ...
                                  <form action="index.php?act=addtocart" method="post">
                                      ...
                                      $i=0;
                                        foreach ($one_size as $size) {
                                            ...
                                            echo '<label class="'.$active.'" ><input type="radio" name="size_name" value="' . $size_name . '" onchange="updateHiddenInput()">' . $size_name . '</label>';
                                            $i+=1;
