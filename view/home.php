                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                ...
                                <a href="#" class="primary-btn">Xem chi tiết <span class="arrow_right"></span></a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    ...
                    <input type="hidden" name="price" value="'.$price_sp.'">
                        ...
                        <div class="product__item__text">
                            ...
                            <h5 style="color:red;">'.$price_sp.' VNĐ</h5>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="instagram__text">
                        <h2>Instagram</h2>
                        <p>Ra mắt vào năm 1982 bởi nhà thiết kế Bruce Kilgore, ngay lập tức mẫu giày Nike Air Force 1 (AF1) đã trở thành một ‘hit’ mạnh trên khắp thế giới khi ‘sold out’ ngay trong ngày đầu trình làng.</p>
                        <h3>#HTD Sneaker</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="view/img/blog/giay5.jpg"></div>
                        <div class="blog__item__text">
                            <span><img src="view/img/icon/calendar.png" alt=""> 16 Tháng Hai 2023</span>
                            <h5>Jordan Đỏ</h5>
                            <a href="#">Đọc thêm</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="view/img/blog/giay9.jpg"></div>
                        <div class="blog__item__text">
                            <span><img src="view/img/icon/calendar.png" alt=""> 21 Tháng Hai 2023</span>
                            <h5>Jordan Đen</h5>
                            <a href="#">Đọc thêm</a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="view/img/blog/giay10.jpg"></div>
                        <div class="blog__item__text">
                            <span><img src="view/img/icon/calendar.png" alt=""> 28 Tháng Hai 2023</span>
                            <h5>Jordan Vàng</h5>
                            <a href="#">Đọc thêm</a>
                        </div>
                    </div>
