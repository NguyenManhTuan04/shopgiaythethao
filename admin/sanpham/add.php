            ...
            <div class="row frmcontent">
                <form action="index.php?act=addsp" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="checkbox" name="sanpham_size[]" value="36" >36 
                        <input type="checkbox" name="sanpham_size[]" value="37" >37 
                        <input type="checkbox" name="sanpham_size[]" value="38" >38 
                        <input type="checkbox" name="sanpham_size[]" value="39" >39 
                        <input type="checkbox" name="sanpham_size[]" value="40" >40 
                        <input type="checkbox" name="sanpham_size[]" value="41" >41
                        <input type="checkbox" name="sanpham_size[]" value="42" >42
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        Tên sản phẩm <br>
